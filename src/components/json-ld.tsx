...
export function JsonLd() {
  const data = [
    { "@context": "https://schema.org", "@type": "Organization", name: SITE_NAME, url: SITE_URL, email: EMAIL, address: { "@type": "PostalAddress", addressLocality: "Lahore", addressCountry: "PK" }, description: SITE_DESCRIPTION },
